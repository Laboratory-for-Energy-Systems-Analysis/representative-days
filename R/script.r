...
set.cty.seas()
xAbs = x.read(fn.path = "Data/", 2017:2019)
xAvl = x.normalize(xAbs, 2017:2019, "SolarWindcapacity.csv")
...
xAbs = x.read(fn.path = "Data/", 2017:2019, load = TRUE)
xNorm = x.normalize(xAbs, 2017:2019, "SolarWindcapacity.csv", load = TRUE)
